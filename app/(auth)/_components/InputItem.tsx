...
export default function InputItem({ inputLabel, inputType, useIcon, usePassword }: InputItemProps) {
  ...
  const emailIcon =
    <svg xmlns="http://www.w3.org/2000/svg" fill="#6744FF" fillOpacity=".25" viewBox="0 0 24 24" stroke="#6744FF" strokeOpacity=".25" strokeWidth={1.5} className="icon-left size-6 text-primary">
      <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 0 1-2.25 2.25h-15a2.25 2.25 0 0 1-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25m19.5 0v.243a2.25 2.25 0 0 1-1.07 1.916l-7.5 4.615a2.25 2.25 0 0 1-2.36 0L3.32 8.91a2.25 2.25 0 0 1-1.07-1.916V6.75" />
    </svg>

  const passwordIcon =
    <svg xmlns="http://www.w3.org/2000/svg" fill="#6744FF" fillOpacity=".25" viewBox="0 0 24 24" strokeWidth={1.5} strokeOpacity=".25" stroke="#6744FF" className="icon-left size-6" style={{}}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 10.5V6.75a4.5 4.5 0 1 0-9 0v3.75m-.75 11.25h10.5a2.25 2.25 0 0 0 2.25-2.25v-6.75a2.25 2.25 0 0 0-2.25-2.25H6.75a2.25 2.25 0 0 0-2.25 2.25v6.75a2.25 2.25 0 0 0 2.25 2.25Z" />
    </svg>

  const eyeOpenIcon = 
    <svg onClick={onClick} xmlns="http://www.w3.org/2000/svg" fillOpacity=".25" fill="#6744FF" viewBox="0 0 24 24" strokeOpacity=".25" strokeWidth={1.5} stroke="#6744FF" className="icon-right size-6" style={{}}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M2.036 12.322a1.012 1.012 0 0 1 0-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178Z" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
    </svg>

  const eyeClosedIcon =
    <svg onClick={onClick} xmlns="http://www.w3.org/2000/svg" fillOpacity=".25" fill="#6744FF" viewBox="0 0 24 24" strokeOpacity=".25" strokeWidth={1.5} stroke="#6744FF" className="icon-right size-6" style={{ right: 0}}>
